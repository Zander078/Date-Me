        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="text-2xl font-bold">Date Me</span>
            </div>
            <p className="text-gray-400 mb-6">
              South Africa's premier dating platform connecting hearts across the nation.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-400">hello@dateme.co.za</span>
              </div>
              <div className="flex items-center">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Date Me. All rights reserved.
            </p>
